...
contract DeferredEquityPlan {
    ...
    function distribute() public {
        ...
        require (unlock_time <= fakenow, "It's too early to vest your shares!");
        require (distributed_shares < total_shares, "You've already vested all your stock!");

        // @TODO: Add 365 days to the `unlock_time`
        unlock_time += 365;

        // @TODO: Calculate the shares distributed
